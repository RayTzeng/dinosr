...
@dataclass
class SemiModelCriterionConfig(FairseqDataclass):
...
@register_criterion("semi_model", dataclass=SemiModelCriterionConfig)
class SemiModelCriterion(FairseqCriterion):
    """
    ...
    def forward(self, model, sample, reduce=True):
        ...
        logging_output = {
            ...
            "_world_size": 1,
            # "sample_size_dict": net_output["sample_size"]
        }
    ...
    def reduce_metrics(logging_outputs) -> None:
        ...
        # sample_size_dict = {}
        # for k, v in logging_outputs[0]['sample_size_dict'].items():
        #     sample_size_dict[k] = utils.item(
        #         sum(log.get("sample_size_dict", 0).get(k, 0) for log in logging_outputs)
        #     )
